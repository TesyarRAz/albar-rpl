@extends('user.app')
@section('content')
<div class="site-blocks-cover" style="background-image: url({{ asset('shopper') }}/images/cimplung3.png);" data-aos="fade">
    <div class="container">
        <div class="row align-items-start align-items-md-center justify-content-end">
            <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
                <h1 class="mb-2">Cari Kebutuhan Aquarium Kamu Di Sini</h1>
                <div class="intro-text text-center text-md-left">
                    <p class="mb-4">Alat Aquarium disini terjamin kualitasnya dan tentunya barangnya juga original bukan kw. </p>
                    <p>
