...
<head>
  <title>E-Cimplung &mdash; Toko Aquarium </title>
  <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="/" class="js-logo-clone">E - Cimplung</a>
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-6">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                ...
                <li class="email">aquarium@gmail.com</li>
              </ul>
            </div>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            <p>
              ...
              </script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" class="text-primary">Cimplung Aquarium</a>
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
