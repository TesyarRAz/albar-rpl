          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h6 class="font-weight-light">mendaftar dengan mudah. hanya beberapa langkah</h6>
                  ...
                  <div class="mb-4">
                    <div class="form-check">
                      <label class="form-check-label text-muted">
                        <input type="checkbox" class="form-check-input"> saya setuju dengan ketentuan dan persyaratan  </label>
                    </div>
                  </div>
                  <div class="mt-3">
